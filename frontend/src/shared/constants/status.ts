export type StatusRole = 'operation' | 'sales' | 'academic' | 'admin' | 'system';
...
export type CollaborationStatusCode = 'none' | 'pending' | 'handling' | 'handled' | 'closed';
...
export const STATUS_META: StatusRegistry = {
  ...
  notificationType: {
    lead_assigned: { code: 'lead_assigned', label: '客资分配', color: 'blue', role: 'sales', actionHint: '查看客资' },
